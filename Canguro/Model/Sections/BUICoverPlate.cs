...
{
    /// <summary>
    /// Sección I cubierta de cobre.
    /// </summary>
    [Serializable]
    public class BUICoverPlate : FrameSection
    {
        public BUICoverPlate(string name, string shape, Material.Material material, ConcreteSectionProps concreteProperties, float t3, float t2, float tf, float tw, float t2b, float tfb, float dis, float area, float torsConst, float i33, float i22, float as2, float as3, float s33, float s22, float z33, float z22, float r33, float r22)
