	...
	public class GlobalizedPropertyDescriptor : PropertyDescriptor
	{
		...
		public override string DisplayName
		{
			get 
			{
				...
				string tableName = "";
				string displayName = "";
                Canguro.Model.UnitSystem.Units units = Canguro.Model.UnitSystem.Units.NoUnit;
				...
				foreach( Attribute oAttrib in this.basePropertyDescriptor.Attributes )
				{
                    ...
                    else if (oAttrib.GetType().Equals(typeof(Model.ModelAttributes.UnitsAttribute)))
                    {
                        units = ((Model.ModelAttributes.UnitsAttribute)oAttrib).Units;
                    }
				}
                ...
                displayName = tableName.Replace(".", "") + displayName.Replace(".", "");
                localizedName = Culture.Get(displayName);
                localizedName = (displayName.Equals(localizedName)) ? basePropertyDescriptor.DisplayName : localizedName;

                if (units != Canguro.Model.UnitSystem.Units.NoUnit)
                    localizedName += " (" + Model.Model.Instance.UnitSystem.UnitName(units) + ")";
		...
		public override string Description
		{
			get
			{
                ...
                displayName = tableName.Replace(".", "") + displayName.Replace(".", "");
                localizedDescription = Culture.Get(displayName);
                localizedDescription = (displayName.Equals(localizedDescription)) ? basePropertyDescriptor.Description : localizedDescription;
		...
		public override void SetValue(object component, object value)
		{
            ...
            catch (Model.ModelIsLockedException) { } // Ignore
		}
	}
	#endregion
