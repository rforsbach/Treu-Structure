...
namespace Canguro.Commands.View
{
    ...
    /// </summary>
    public class ColorLinesBySection : Canguro.Commands.ViewCommand
    {
        private ColorLinesBySection() { }
        public static ColorLinesBySection Instance = new ColorLinesBySection();
        ...
        public override void Run(Canguro.View.GraphicView activeView)
        {
            ...
            if (mr != null)
                mr.RenderOptions.LineColoredBy = Canguro.View.Renderer.RenderOptions.LineColorBy.Section;
        }
    }
}
